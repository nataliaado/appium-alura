...
public class AppiumDriverConfig {
    ...
    private AppiumDriverConfig() {
        File apk = new File("C:\\Users\\Nataliaado\\Documents\\AluraAppium\\src\\main\\resources\\alura_esporte.apk");
        ...
        configuracoes.setCapability(MobileCapabilityType.APPLICATION_NAME, "UiAutomator2");
